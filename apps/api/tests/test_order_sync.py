...
# _detect_external_closes, the option lifecycle (expiry, exercise), the
# unacknowledged-order grace and filled-at-acknowledgement orders are
# covered end to end by apps/api/tests/e2e, against a real database.
